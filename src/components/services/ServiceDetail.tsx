...
const ServiceDetail = () => {
  return (
    <section className="py-20 bg-white" id="service-detail">
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-xl mb-1">Technical SEO Audit</h3>
                  <p className="text-gray-700">Comprehensive analysis of your website's structure, performance, and search visibility.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <CheckCircle2 className="h-6 w-6 text-marketing-blue mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h3 className="font-bold text-xl mb-1">Keyword Research & Strategy</h3>
                  <p className="text-gray-700">Identifying high-value keywords that your target audience is searching for.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <CheckCircle2 className="h-6 w-6 text-marketing-blue mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h3 className="font-bold text-xl mb-1">On-Page Optimization</h3>
                  <p className="text-gray-700">Optimizing content, meta tags, and site structure to improve search relevance.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <CheckCircle2 className="h-6 w-6 text-marketing-blue mt-1 mr-3 flex-shrink-0" />
                <div>
                  <h3 className="font-bold text-xl mb-1">Link Building</h3>
                  <p className="text-gray-700">Acquiring high-quality backlinks from reputable sources to boost authority.</p>
                </div>
              </div>
            </div>
